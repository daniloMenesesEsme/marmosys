...
if (!$hasColumn) {
    ...
    Schema::table('sellers', function (Blueprint $table) {
        $table->unsignedBigInteger('region_id')->nullable()->after('ativo');
...
// Verificar a estrutura da tabela sellers após a atualização
$columns = DB::select('SHOW COLUMNS FROM sellers');
$columnNames = array_map(function($column) {
    return $column->Field;
}, $columns);

echo "Colunas da tabela 'sellers' após atualização: " . implode(', ', $columnNames) . "\n";
