<?php $__env->startSection('title', isset($paymentMethod) ? 'Editar Forma de Pagamento' : 'Nova Forma de Pagamento'); ?>
            ...
            <div class="card">
                <div class="card-content">
                    <span class="card-title">
                        <i class="material-icons left"><?php echo e(isset($paymentMethod) ? 'edit' : 'add_circle'); ?></i>
                        <?php echo e(isset($paymentMethod) ? 'Editar Forma de Pagamento' : 'Nova Forma de Pagamento'); ?>

                    </span>

                    <form action="<?php echo e(isset($paymentMethod) ? 
                        ...
                        <input type="hidden" name="parcelas_padrao" value="<?php echo e(old('parcelas_padrao', $paymentMethod->parcelas_padrao ?? 1)); ?>">
                        <input type="hidden" name="taxa_padrao" value="<?php echo e(old('taxa_padrao', $paymentMethod->taxa_padrao ?? 0)); ?>">
                            ...
                            <div id="principal" class="col s12" style="margin-top: 20px;">
                                <div class="row">
                                    <div class="input-field col s12 m3">
                                        <input type="text" id="codigo" name="codigo" value="<?php echo e(old('codigo', $paymentMethod->codigo ?? '')); ?>" maxlength="10">
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="input-field col s12 m9">
                                        <input type="text" id="nome" name="nome" value="<?php echo e(old('nome', $paymentMethod->nome ?? $paymentMethod->descricao ?? '')); ?>" required>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="row">
                                    <div class="input-field col s12">
                                        <textarea id="descricao" name="descricao" class="materialize-textarea"><?php echo e(old('descricao', $paymentMethod->descricao ?? '')); ?></textarea>
                                ...
                                <div class="row">
                                    <div class="input-field col s12 m6">
                                        <select name="especie_documento" id="especie_documento" required>
                                            ...
                                            <?php $__currentLoopData = \App\Models\PaymentMethod::TIPOS; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($key); ?>" <?php echo e(old('especie_documento', $paymentMethod->especie_documento ?? '') == $key ? 'selected' : ''); ?>>
                                                    <?php echo e($value); ?>
                                    ...
                                    <input type="hidden" id="tipo" name="tipo" value="<?php echo e(old('tipo', old('especie_documento', $paymentMethod->tipo ?? $paymentMethod->especie_documento ?? ''))); ?>">
                                    ...
                                    <div class="input-field col s12 m6">
                                        <select name="categoria_financeira_id" id="categoria_financeira_id" required>
                                            ...
                                            <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($category->id); ?>" 
                                                    <?php echo e(old('categoria_financeira_id', $paymentMethod->categoria_financeira_id ?? '') == $category->id ? 'selected' : ''); ?>>
                                        ...
                                        <?php $__errorArgs = ['categoria_financeira_id'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="row">
                                    <div class="col s12">
                                        <label>
                                            <input type="checkbox" name="controle_cartao" class="filled-in" <?php echo e(old('controle_cartao', $paymentMethod->controle_cartao ?? '') ? 'checked' : ''); ?>>
                                            <span>Controle de Cartão</span>
                                        </label>
                                        <label style="margin-left: 20px;">
                                            <input type="checkbox" name="movimenta_conta_corrente" class="filled-in" <?php echo e(old('movimenta_conta_corrente', $paymentMethod->movimenta_conta_corrente ?? '') ? 'checked' : ''); ?>>
                                            <span>Movimenta conta corrente</span>
                                        </label>
                                        <label style="margin-left: 20px;">
                                            <input type="checkbox" name="emite_comprovantes_vinculados" class="filled-in" <?php echo e(old('emite_comprovantes_vinculados', $paymentMethod->emite_comprovantes_vinculados ?? '') ? 'checked' : ''); ?>>
                                            <span>Emite comprovantes vinculados</span>
                                        </label>
                                        <label style="margin-left: 20px;">
                                            <input type="checkbox" name="ativo" class="filled-in" <?php echo e(old('ativo', $paymentMethod->ativo ?? true) ? 'checked' : ''); ?>>
                                            <span>Ativo</span>
                                        </label>
                                        <label style="margin-left: 20px;">
                                            <input type="checkbox" name="gera_financeiro" class="filled-in" <?php echo e(old('gera_financeiro', $paymentMethod->gera_financeiro ?? true) ? 'checked' : ''); ?>>
                                            <span>Gera Financeiro</span>
                                        </label>
                                        <label style="margin-left: 20px;">
                                            <input type="checkbox" name="envia_pdv" class="filled-in" <?php echo e(old('envia_pdv', $paymentMethod->envia_pdv ?? '') ? 'checked' : ''); ?>>
                                            <span>Envia PDV</span>
                                        </label>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="input-field col s12 m6 select-field">
                                        <select name="financial_agent_id" id="financial_agent_id">
                                            ...
                                            <?php $__currentLoopData = $financialAgents; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $agent): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($agent->id); ?>" 
                                                    <?php echo e(old('financial_agent_id', $paymentMethod->financial_agent_id ?? '') == $agent->id ? 'selected' : ''); ?>>
                                                    <?php echo e($agent->nome); ?> (<?php echo e(\App\Models\FinancialAgent::TIPOS[$agent->tipo]); ?>)
                                                </option>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        </select>
                                        <label for="financial_agent_id">Agente Financeiro</label>
                                        <?php $__errorArgs = ['financial_agent_id'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div id="fiscal" class="col s12" style="margin-top: 20px;">
                                <div class="row">
                                    <div class="input-field col s12 m3">
                                        <input type="text" id="codigo_fiscal" name="codigo_fiscal" value="<?php echo e(old('codigo_fiscal', $paymentMethod->codigo_fiscal ?? '')); ?>">
                                        <label for="codigo_fiscal">Código Fiscal</label>
                                    </div>

                                    <div class="input-field col s12 m9">
                                        <input type="text" id="descricao_fiscal" name="descricao_fiscal" value="<?php echo e(old('descricao_fiscal', $paymentMethod->descricao_fiscal ?? '')); ?>">
                                    ...
                                    <div class="card-content">
                                        ...
                                        <div class="row" style="margin-top: 20px;">
                                            <div class="col s12">
                                                <div class="switch">
                                                    <label>
                                                        <input type="checkbox" name="movimenta_conta_corrente" id="movimenta_conta_corrente" <?php echo e(old('movimenta_conta_corrente', $paymentMethod->movimenta_conta_corrente ?? 0) ? 'checked' : ''); ?> value="1">
                                ...
                                <div class="row">
                                    <div class="col s12">
                                        ...
                                        <div class="row">
                                            <div class="col s12">
                                                <label style="margin-right: 20px;">
                                                    <input name="especie_pdv" type="radio" value="dinheiro" <?php echo e(old('especie_pdv', $paymentMethod->especie_pdv ?? '') == 'dinheiro' ? 'checked' : ''); ?>>
                                                    <span>Dinheiro</span>
                                                </label>
                                                <label style="margin-right: 20px;">
                                                    <input name="especie_pdv" type="radio" value="cheque" <?php echo e(old('especie_pdv', $paymentMethod->especie_pdv ?? '') == 'cheque' ? 'checked' : ''); ?>>
                                                    <span>Cheque</span>
                                                </label>
                                                <label style="margin-right: 20px;">
                                                    <input name="especie_pdv" type="radio" value="cartao_credito" <?php echo e(old('especie_pdv', $paymentMethod->especie_pdv ?? '') == 'cartao_credito' ? 'checked' : ''); ?>>
                                                    <span>Cartão de Crédito</span>
                                                </label>
                                                <label style="margin-right: 20px;">
                                                    <input name="especie_pdv" type="radio" value="cartao_debito" <?php echo e(old('especie_pdv', $paymentMethod->especie_pdv ?? '') == 'cartao_debito' ? 'checked' : ''); ?>>
                                                    <span>Cartão de Débito</span>
                                                </label>
                                                <label style="margin-right: 20px;">
                                                    <input name="especie_pdv" type="radio" value="pix" <?php echo e(old('especie_pdv', $paymentMethod->especie_pdv ?? '') == 'pix' ? 'checked' : ''); ?>>
                                                    <span>PIX</span>
                                                </label>
                                                <label style="margin-right: 20px;">
                                                    <input name="especie_pdv" type="radio" value="outros" <?php echo e(old('especie_pdv', $paymentMethod->especie_pdv ?? '') == 'outros' ? 'checked' : ''); ?>>
                                                    <span>Outros</span>
                                                </label>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="col s12">
                                                <label style="margin-right: 20px;">
                                                    <input type="checkbox" name="pagamento" class="filled-in" <?php echo e(old('pagamento', $paymentMethod->pagamento ?? '') ? 'checked' : ''); ?>>
                                                    <span>Pagamento</span>
                                                </label>
                                                <label style="margin-right: 20px;">
                                                    <input type="checkbox" name="permite_troco" class="filled-in" <?php echo e(old('permite_troco', $paymentMethod->permite_troco ?? true) ? 'checked' : ''); ?>>
                                                    <span>Permite Troco</span>
                                                </label>
                                                <label style="margin-right: 20px;">
                                                    <input type="checkbox" name="sangria_automatica" class="filled-in" <?php echo e(old('sangria_automatica', $paymentMethod->sangria_automatica ?? '') ? 'checked' : ''); ?>>
                                        ...
                                        <div class="row">
                                            <div class="input-field col s12 m3">
                                                <input type="number" step="0.01" id="valor_minimo" name="valor_minimo" value="<?php echo e(old('valor_minimo', $paymentMethod->valor_minimo ?? '')); ?>">
                                                <label for="valor_minimo">Valor Mínimo</label>
                                            </div>
                                            <div class="input-field col s12 m3">
                                                <input type="number" step="0.01" id="valor_maximo" name="valor_maximo" value="<?php echo e(old('valor_maximo', $paymentMethod->valor_maximo ?? '')); ?>">
                                                <label for="valor_maximo">Valor Máximo</label>
                                            </div>
                                            <div class="input-field col s12 m3">
                                                <input type="number" step="0.01" id="troco_maximo" name="troco_maximo" value="<?php echo e(old('troco_maximo', $paymentMethod->troco_maximo ?? '')); ?>">
                                                <label for="troco_maximo">Troco Máximo</label>
                                            </div>
                                            <div class="input-field col s12 m3">
                                                <input type="number" step="0.01" id="valor_minimo_parcela" name="valor_minimo_parcela" value="<?php echo e(old('valor_minimo_parcela', $paymentMethod->valor_minimo_parcela ?? '')); ?>">
                                        ...
                                        <div class="row">
                                            <div class="input-field col s12 m4">
                                                <input type="number" id="parcelas_minimas" name="parcelas_minimas" value="<?php echo e(old('parcelas_minimas', $paymentMethod->parcelas_minimas ?? 1)); ?>">
                                                <label for="parcelas_minimas">Parcelas Mínimas</label>
                                            </div>
                                            <div class="input-field col s12 m4">
                                                <input type="number" id="parcelas_maximas" name="parcelas_maximas" value="<?php echo e(old('parcelas_maximas', $paymentMethod->parcelas_maximas ?? 1)); ?>">
                                                <label for="parcelas_maximas">Parcelas Máximas</label>
                                            </div>
                                            <div class="input-field col s12 m4">
                                                <input type="number" id="prazo" name="prazo" value="<?php echo e(old('prazo', $paymentMethod->prazo ?? 0)); ?>">
                                        ...
                                        <div class="row">
                                            <div class="input-field col s12 m6">
                                                <input type="time" id="horario_inicio" name="horario_inicio" value="<?php echo e(old('horario_inicio', $paymentMethod->horario_inicio ?? '')); ?>">
                                                <label for="horario_inicio">Horário Inicial</label>
                                            </div>
                                            <div class="input-field col s12 m6">
                                                <input type="time" id="horario_fim" name="horario_fim" value="<?php echo e(old('horario_fim', $paymentMethod->horario_fim ?? '')); ?>">
                                        ...
                                        <div class="row">
                                            <div class="col s12">
                                                <label style="margin-right: 20px;">
                                                    <input type="checkbox" name="usa_tef" class="filled-in" <?php echo e(old('usa_tef', $paymentMethod->usa_tef ?? '') ? 'checked' : ''); ?>>
                                                    <span>Usa TEF</span>
                                                </label>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="input-field col s12 m6">
                                                <select name="bandeira_tef" id="bandeira_tef">
                                                    ...
                                                    <?php $__currentLoopData = \App\Models\PaymentMethod::BANDEIRAS_TEF; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <option value="<?php echo e($key); ?>" <?php echo e(old('bandeira_tef', $paymentMethod->bandeira_tef ?? '') == $key ? 'selected' : ''); ?>>
                                                            <?php echo e($value); ?>
                                            ...
                                            <div class="input-field col s12 m6">
                                                <input type="text" id="nsu_tef" name="nsu_tef" value="<?php echo e(old('nsu_tef', $paymentMethod->nsu_tef ?? '')); ?>">
                                        ...
                                        <div class="row">
                                            <div class="col s12 m4">
                                                ...
                                                <select name="tipo_cliente" class="browser-default">
                                                    <option value="codigo" <?php echo e(old('tipo_cliente', $paymentMethod->tipo_cliente ?? '') == 'codigo' ? 'selected' : ''); ?>>Código</option>
                                                    <option value="pin_pad" <?php echo e(old('tipo_cliente', $paymentMethod->tipo_cliente ?? '') == 'pin_pad' ? 'selected' : ''); ?>>Pin Pad</option>
                                                </select>
                                            </div>
                                            <div class="col s12 m8">
                                                <p>
                                                    <label>
                                                        <input type="checkbox" name="pin_pad" class="filled-in" <?php echo e(old('pin_pad', $paymentMethod->pin_pad ?? '') ? 'checked' : ''); ?>>
...
<script>
    ...
    function carregarLojas() {
        ...
        $.ajax({
            url: '<?php echo e(route("api.stores.list")); ?>',
            type: 'GET',
            dataType: 'json',
    ...
    function carregarContasCorrentes() {
        ...
        $.ajax({
            url: '<?php echo e(route("api.current-accounts.by-store")); ?>',
            type: 'GET',
...
<?php $__env->stopPush(); ?> 
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\marmosys\resources\views/financial/registration/payment-methods/form.blade.php ENDPATH**/ ?>