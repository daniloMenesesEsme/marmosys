...
<?php $__env->startSection('title', 'Relatório de Vendedores'); ?>
        ...
        <div class="col s12">
            <div class="card">
                <div class="card-content">
                    ...
                    <div class="row">
                        <div class="col s12">
                            <form action="<?php echo e(route('sellers.report')); ?>" method="GET" class="row">
                                <div class="input-field col s12 m3">
                                    <input type="text" name="nome" id="nome" value="<?php echo e(request('nome')); ?>">
                                ...
                                <div class="input-field col s12 m3">
                                    <input type="date" name="data_inicio" id="data_inicio" value="<?php echo e(request('data_inicio')); ?>">
                                    <label for="data_inicio">Data Admissão (Início)</label>
                                </div>
                                
                                <div class="input-field col s12 m3">
                                    <input type="date" name="data_fim" id="data_fim" value="<?php echo e(request('data_fim')); ?>">
                                    <label for="data_fim">Data Admissão (Fim)</label>
                                </div>
                                
                                <div class="input-field col s12 m3">
                                    <input type="number" step="0.01" name="comissao_min" id="comissao_min" value="<?php echo e(request('comissao_min')); ?>">
                                    <label for="comissao_min">Comissão Mínima (%)</label>
                                </div>
                                
                                <div class="input-field col s12 m3">
                                    <input type="number" step="0.01" name="comissao_max" id="comissao_max" value="<?php echo e(request('comissao_max')); ?>">
                                    <label for="comissao_max">Comissão Máxima (%)</label>
                                </div>
                                
                                <div class="input-field col s12 m3">
                                    <input type="date" name="periodo_inicio" id="periodo_inicio" value="<?php echo e(request('periodo_inicio')); ?>">
                                    <label for="periodo_inicio">Período Orçamentos (Início)</label>
                                </div>
                                
                                <div class="input-field col s12 m3">
                                    <input type="date" name="periodo_fim" id="periodo_fim" value="<?php echo e(request('periodo_fim')); ?>">
                                ...
                                <div class="col s12 m12 center-align">
                                    ...
                                    <a href="<?php echo e(route('sellers.report')); ?>" class="btn waves-effect waves-light red">
                                        <i class="material-icons left">clear</i> Limpar Filtros
                                    </a>
                                    
                                    <a href="<?php echo e(route('sellers.report', array_merge(request()->all(), ['pdf' => true]))); ?>" class="btn waves-effect waves-light blue">
                        ...
                        <div class="col s12 m4">
                            <div class="card blue-grey darken-1">
                                <div class="card-content white-text">
                                    ...
                                    <h4><?php echo e($totals['vendedores_ativos']); ?></h4>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col s12 m4">
                            <div class="card red darken-1">
                                <div class="card-content white-text">
                                    ...
                                    <h4><?php echo e($totals['vendedores_inativos']); ?></h4>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col s12 m4">
                            <div class="card teal darken-1">
                                <div class="card-content white-text">
                                    ...
                                    <h4><?php echo e($totals['total_vendedores']); ?></h4>
                                </div>
                            </div>
                        </div>
                    </div>
                                ...
                                <tbody>
                                    <?php $__empty_1 = true; $__currentLoopData = $sellers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $seller): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                        <tr>
                                            ...
                                            <td>
                                                <span class="badge <?php echo e($seller->ativo ? 'green' : 'red'); ?> white-text">
...
<div id="printTemplate" style="display: none;">
    <div class="header clearfix">
        ...
        <div class="header-right">
            ...
            <div class="header-info">
                ...
                <strong>Período:</strong> <?php echo e(request('data_inicio') ? date('d/m/Y', strtotime(request('data_inicio'))) : 'Todos'); ?> até 
                                          <?php echo e(request('data_fim') ? date('d/m/Y', strtotime(request('data_fim'))) : 'Todos'); ?>
    ...
    <div class="filters">
        ...
        Nome: <?php echo e(request('nome') ?: 'Todos'); ?> |
        Status: <?php echo e(request('status') ? ucfirst(request('status')) : 'Todos'); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\marmosys\resources\views/sellers/report.blade.php ENDPATH**/ ?>