...
<div class="container">
    <div class="row mb-3">
        <div class="col s12">
            <h4>Novo Tipo de Estabelecimento</h4>
        </div>
    </div>
        ...
        <div class="col s12">
            <div class="card">
                <div class="card-content">
                    <form action="{{ route('establishment-types.store') }}" method="POST">
                        @csrf
                        ...
                        <div class="row">
                            <div class="input-field col s12 m6">
                                <input id="avg_ticket" type="number" step="0.01" min="0" name="avg_ticket" value="{{ old('avg_ticket') }}">
                            ...
                            <div class="input-field col s12 m6">
                                <input id="potential_level" type="number" step="1" min="1" max="10" name="potential_level" value="{{ old('potential_level', 5) }}">
