        ...
        <div class="col s12">
            <div class="card">
                <div class="card-content">
                    ...
                    <form action="{{ isset($agent) ? route('financial.agents.update', $agent) : route('financial.agents.store') }}" method="POST">
                        @csrf
                        @if(isset($agent))
                            @method('PUT')
                        @endif
                        ...
                        <div class="row">
                            <div class="col s12">
                                ...
                                <a href="{{ route('financial.agents.index') }}" class="btn waves-effect waves-light grey">
