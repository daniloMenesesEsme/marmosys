            ...
            <div class="card">
                <div class="card-content">
                    <div class="card-title">
                        <div class="row">
                            <div class="col s12">
                                <h4><i class="material-icons left">person_add</i> Novo Vendedor</h4>
                            </div>
                        </div>
                    </div>

                    <form action="{{ route('sellers.store') }}" method="POST" class="col s12">
                        @csrf
                        ...
                        <div class="row">
                            ...
                            <div class="input-field col s12 m6">
                                ...
                                <input type="text" name="cpf" id="cpf" value="{{ old('cpf') }}" class="cpf" required>
                            ...
                            <div class="input-field col s12 m6">
                                ...
                                <input type="text" name="telefone" id="telefone" value="{{ old('telefone') }}" class="telefone" required>
                        ...
                        <div class="row">
                            ...
                            <div class="input-field col s12 m4">
                                ...
                                <input type="text" name="cep" id="cep" value="{{ old('cep') }}" class="cep">
                        ...
                        <div class="row">
                            ...
                            <div class="input-field col s12 m6">
                                ...
                                <input type="number" name="percentual_comissao" id="percentual_comissao" step="0.01" min="0" max="100" value="{{ old('percentual_comissao', 5) }}" required>
                            ...
                            <div class="input-field col s12 m6">
                                ...
                                <input type="number" name="meta_mensal" id="meta_mensal" step="0.01" min="0" value="{{ old('meta_mensal', 0) }}" required>
                            ...
                            <div class="input-field col s12">
                                ...
                                <textarea name="observacoes" id="observacoes" class="materialize-textarea">{{ old('observacoes') }}</textarea>
                            ...
                            <div class="input-field col s12">
                                <div class="switch">
                                    <label>
                                        Inativo
                                        <input type="checkbox" name="ativo" {{ old('ativo') ? 'checked' : '' }} value="1" checked>
