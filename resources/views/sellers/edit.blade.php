            ...
            <div class="card">
                <div class="card-content">
                    <div class="card-title">
                        <div class="row">
                            <div class="col s12">
                                <h4><i class="material-icons left">edit</i> Editar Vendedor</h4>
                            </div>
                        </div>
                    </div>

                    <form action="{{ route('sellers.update', $seller) }}" method="POST" class="col s12">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="row">
                            ...
                            <div class="input-field col s12 m6">
                                ...
                                <input type="number" name="percentual_comissao" id="percentual_comissao" step="0.01" min="0" max="100" value="{{ old('percentual_comissao', $seller->percentual_comissao) }}" required>
                            ...
                            <div class="input-field col s12 m6">
                                ...
                                <input type="number" name="meta_mensal" id="meta_mensal" step="0.01" min="0" value="{{ old('meta_mensal', $seller->meta_mensal) }}" required>
                            ...
                            <div class="input-field col s12">
                                <div class="switch">
                                    <label>
                                        Inativo
                                        <input type="checkbox" name="ativo" {{ old('ativo', $seller->ativo) ? 'checked' : '' }} value="1">
