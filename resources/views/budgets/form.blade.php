            ...
            <div class="card-content">
                ...
                <form action="{{ isset($budget) ? route('budgets.update', $budget) : route('budgets.store') }}" method="POST">
                    ...
                    <div class="row">
                        ...
                        <div class="input-field col s12 m6">
                            <input type="date" id="data" name="data" value="{{ old('data', isset($budget) ? $budget->data->format('Y-m-d') : date('Y-m-d')) }}" required>
                            <label for="data">Data*</label>
                            @error('data') <span class="red-text">{{ $message }}</span> @enderror
                        </div>
                    </div>
